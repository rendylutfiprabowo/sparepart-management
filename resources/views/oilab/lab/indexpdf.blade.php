...
<body style="width: 800px;">
    <div class="container">
        <div class="p-2">
            <img src="{{ public_path('/Asset/LogoTrafoindo.png') }}" width="120" height="50" class="d-inline-block"
                alt="LOGO">
        </div>
        <br>
        <div>
            <table border="1">
                ...
                <tr>
                    <td>Tanggal Sampling <br>
                        <span> 6/6/2023</span>
                    </td>
                    <td>-</td>
                </tr>
                <tr>
                    <td>Tanggal Terima <br> <span> 6/6/2023</span></td>
                    <td>-</td>
                </tr>
                <tr>
                    <td>Tanggal Pengujian <br> <span> 6/6/2023</span></td>
                    <td>-</td>
                </tr>
    ...
    <div class="container">
        <div class="p-2">
            <img src="{{ public_path('/Asset/LogoTrafoindo.png') }}" width="120" height="50"
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td style="border: none;">:_________</td>
            </tr>
            <tr>
