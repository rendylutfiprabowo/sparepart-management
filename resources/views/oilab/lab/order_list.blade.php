    ...
    <div class="col-md-12">
        <div class="card rounded-4" style="border-left-color: red; border-left-width: 10px;">
            <div class="card-body shadow">
                <h6 class="text-start font-weight-bold " style="color: black;">Tabel dibawah ini Informasi data order Oil Lab</h6>
            </div>
        </div>
    </div>
</div>
                ...
                <table class=" text-center table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>In Progress</td>
                            <td><a href="/order_list1/{{$solab['no_so_solab']}}" type="button" class="btn merah text-putih">detail</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
