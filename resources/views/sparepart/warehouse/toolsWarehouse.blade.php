...
@section('contents')
    <div class="col-md-12">
        <div class="card rounded-4 mb-4 p-4">
            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addtools"><i
    ...
    <!--Add Product Modal -->
    <div class="modal fade" id="addtools" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="/warehouse/tools/store">
                        @csrf
                        <div class="card-body">
                            @if ($errors->any())
