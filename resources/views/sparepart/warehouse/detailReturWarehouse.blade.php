...
@section('contents')
    ...
    {{-- @dd(Auth::user()->warehouse->id_store) --}}
    @if ($order->id_store != Auth::user()->warehouse->id_store)
            ...
            <div class="">
                @if ($type == null || $type == 'MEMO')
                    <form action="/sales/sparepart/revision/{{ $order->id_order }}" method="post">
                        ...
                        <div class="row my-5">
                            <div class="col-3">
                                <select name="do-memo" id="" disabled class="form-control">
                                    @if ($order->do_order)
                            ...
                            <div class="col">
                                <input type="text" class="form-control" placeholder="No. DO/Memo DO" name="no-do-memo"
                                    @if ($type == 'DO') value="{{ $order->do_order }}" disabled
                ...
                @else
                    ...
                    <div class="row my-2">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" placeholder="No. DO/Memo DO" name="no-do-memo"
                                value="{{ $order->do_order }}" disabled>
                        </div>
                    </div>
                    <div class="modal-footer my-3">
                        <a href="/warehouse/returItem" class="btn btn-secondary"> Back</a>
                    </div>
                @endif
            </div>
        </div>
                ...
                @if ($type == null || $type == 'MEMO')
                    <form action="/sales/sparepart/revision/{{ $order->id_order }}" method="post">
                        ...
                        <div class="row my-5">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" placeholder="No. DO/Memo DO"
                                    name="no-do-memo"
