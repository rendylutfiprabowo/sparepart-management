                        ...
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li class="ms-4">
                                <a href="/sales/sparepart/index"
                                    class="nav-link d-inline-flex text-decoration-none rounded {{ Request::is('sales/sparepart/index*') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
                                        class="bi bi-house-gear me-1"></i> <span class="me-2">Dashboard</span></a>
                            </li>
                            <li class="ms-4"><a href="/sales/sparepart/stock"
                                    class=" nav-link  d-inline-flex text-decoration-none rounded {{ Request::is('sales/sparepart/stock*') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
                                        class="bi bi-box-seam me-1"></i> <span class="me-2">Stock</span></a>
                            </li>
                            <li class="ms-4"><a href="/sales/sparepart/revision"
                                    class=" nav-link  d-inline-flex text-decoration-none rounded {{ Request::is('sales/sparepart/revision*') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
                                        class="bi bi-file-earmark-diff me-1"></i> <span class="me-2">Pengajuan
                                        Revisi</span></a>
                            </li>
                            <li class="ms-4"><a href="/sales/sparepart/order"
                                    class=" nav-link  d-inline-flex text-decoration-none rounded {{ Request::is('sales/sparepart/order*') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
                    ...
                    <div class="collapse" id="dashboard-collapse-oil">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li class="ms-4"><a href="/sales/oil/index"
                                    class="nav-link d-inline-flex text-decoration-none rounded {{ Request::is('sales/oil/index') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
                                        class="bi bi-grid me-1"></i> <span class="me-2">Dashboard</span></a>
                            </li>
                            <li class="ms-4"><a href="/sales/oil/salesorder"
                                    class=" nav-link  d-inline-flex text-decoration-none rounded {{ Request::is('sales/oil/salesorder*') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
                            ...
                            <li class="ms-4"><a href="/sales/oil/history"
                                    class=" nav-link  d-inline-flex text-decoration-none rounded {{ Request::is('sales/oil/history*') ? 'text-white active-sidebar-link' : 'fw-normal' }}"><i
