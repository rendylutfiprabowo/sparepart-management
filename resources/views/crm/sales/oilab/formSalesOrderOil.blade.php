                ...
                <div class="row mb-3 border p-3" style="background-color: white;">
                    <div class="col-md-12">
                                    ...
                                    <div class="container mt-2">
                                        <div class="input-group" style="width: 150px;">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-outline-secondary merah text-putih" type="button"
                                                    id="minusButton1" style="padding: 0.25rem 0.5rem;">-</button>
                                            </div>
                                            <input type="text" name="dga_qty" class="form-control text-center"
                                                value="0" id="quantityInput1"
                                                style="height: calc(1.5em + 0.75rem + 2px);">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary merah text-putih" type="button"
                                                    id="plusButton1" style="padding: 0.25rem 0.5rem;">+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-check mt-3 ml-2">
                                    <input class="form-check-input" type="checkbox" name="furan_check"
                                        id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">
                                        <strong>Furan</strong>
                                    </label>
                                ...
                                <div>
                                    <div class="container mt-2">
                                        <div class="input-group" style="width: 150px;">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-outline-secondary merah text-putih" type="button"
                                                    id="minusButton2" style="padding: 0.25rem 0.5rem;">-</button>
                                            </div>
                                            <input type="text" name="furan_qty" class="form-control text-center"
                                                value="0" id="quantityInput2"
                                                style="height: calc(1.5em + 0.75rem + 2px);">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary merah text-putih" type="button"
                                                    id="plusButton2" style="padding: 0.25rem 0.5rem;">+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="container mt-2">
                                        <div class="input-group" style="width: 150px;">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-outline-secondary merah text-putih" type="button"
                                                    id="minusButton3" style="padding: 0.25rem 0.5rem;">-</button>
                                            </div>
                                            <input type="text" name="oa_qty" class="form-control text-center"
                                                value="0" id="quantityInput3"
                                                style="height: calc(1.5em + 0.75rem + 2px);">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary merah text-putih" type="button"
                                                    id="plusButton3" style="padding: 0.25rem 0.5rem;">+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
