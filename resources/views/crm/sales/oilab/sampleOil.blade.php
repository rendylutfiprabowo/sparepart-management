    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody class="text-center">
            <tr>
                ...
                <td><button href="#" class="btn" type="button" data-toggle="modal" data-target="#exampleModal"><i
                            class="fa-regular fa-file fa-xl"></i></button></td>
            </tr>
            <tr>
                <td>A9099886</td>
                <td>PLN</td>
                ...
                <td>
                    <a href="/sample_Sales" class="btn" type="button" data-toggle="modal" data-target="#exampleModal"><i
