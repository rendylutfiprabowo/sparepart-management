...
@section('contents')
        ...
        <tbody class="text-center">
            @foreach ($salesorderoil as $solab)
                <tr>
                    ...
                    <td><button href="#" class="btn" type="button" data-toggle="modal"
                            data-target="#exampleModal{{ $solab['no_so_solab'] }}"><i
    ...
    <!-- Modal -->
    @foreach ($salesorderoil as $solab)
        <div class="modal fade" id="exampleModal{{ $solab['no_so_solab'] }}" tabindex="-1"
