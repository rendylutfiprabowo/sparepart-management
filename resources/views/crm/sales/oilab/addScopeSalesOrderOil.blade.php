                            ...
                            <div class="col-md-12">
                                ...
                                <div>
                                    <button class="btn btn-white dropdown-toggle mt-2" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#collapseExampleOil" aria-expanded="false"
                                        aria-controls="collapseExampleOil">
                                ...
                                <div class="collapse" id="collapseExampleOil">
                                    ...
                                    <div class="form-check ml-2">
                                        <input class="form-check-input" type="checkbox" name="check[oa][corrosif_sulfur]"
                                            id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
